![logo](https://github.com/MR-NOOB-333/All/blob/main/file_0000000011f861f8bc70068944379edc.png)

if you have root and run it it will automatically install steam linux

**GHOST EMULATOR** is a project created by [MR-NOOB-404 (The owner and the main developer)], [MOHAMMAD PAPEL (The second owner and the second main developer)], [MOHAMMAD RAFI]
...
curl -s -o ~/x https://raw.githubusercontent.com/MR-NOOB-333/GHOST-EMULATOR/main/install && . ~/x
...
### Run boxvidra :
* `ghost` To Run Ghost
* `ghost --update` To Update Ghost
* `ghost --reinstall` To Reinstall Ghost
* `ghost --uninstall ` To Uninstall Ghost
